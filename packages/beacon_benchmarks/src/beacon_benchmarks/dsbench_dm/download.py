"""Download DSBench-DM from the public GitHub repository or a configured mirror."""
...
MIRROR_URL = mirror_url("benchmarks/DSBenchDM.zip")
DSBENCH_DM_PLACEHOLDER_SHA256 = "d" + "m" * 63
...
def download_dsbench_dm(dest: Path, include_large: bool = False) -> Path:
    """Download and extract DSBench-DM under ``dest``."""
    ...
    tarball = dest / "dsbench_dm.tar.gz"
